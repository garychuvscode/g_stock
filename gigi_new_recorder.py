...
class data_capture():
    ...
    def reorder_pd(self, stock_id, stock_name, date):
        ...
        inputfilename = 'c:\\py_gary\\stock_data\\' + '_' + datestr + '.csv'
        # outputfilename = 'c:\\py_gary\\stock_data\\' + '_' + datestr + '.csv.gz'
        outputfilename = 'c:\\py_gary\\stock_data\\' + '_1_' + datestr + '.csv'
        ...
        # index is to record the index of each row or not, set to false to make row
        # data become clear
